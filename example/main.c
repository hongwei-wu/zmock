...
int main(int argc, char **argv)
{
        ...
        zmock_will_always_call(func_return_int, mock_func_return_int);
        val = func_return_int(1);
        assert(val == 2);

        zmock_will_always_call(func_return_int_ptr, mock_func_return_int_ptr);
        ...
        zmock_will_return(func_return_int, 3);
        val = func_return_int(1);
        assert(val == 3);

        zmock_will_return(func_return_int_ptr, dummy_ptr);
        ptr = func_return_int_ptr(&val);
        assert(ptr == dummy_ptr);
